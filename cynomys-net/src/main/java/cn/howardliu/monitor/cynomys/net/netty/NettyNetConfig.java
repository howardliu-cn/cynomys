...
final class NettyNetConfig {
    ...
    public static final int CLIENT_ASYNC_SEMAPHORE_VALUE = parseInt(System.getProperty(CYNOMYS_NET_CLIENT_ASYNC_SEMAPHORE_VALUE, "65535"));
    ...
    static int socketMaxFrameLength = parseInt(System.getProperty(CYNOMYS_NET_SOCKET_MAX_FRAME_LENGTH, Integer.toString((10 * 1024 * 1024))));
