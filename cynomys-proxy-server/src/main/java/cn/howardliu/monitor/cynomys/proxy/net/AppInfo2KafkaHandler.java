...
public class AppInfo2KafkaHandler extends AbstractInfo2KafkaHandler {
    ...
    public AppInfo2KafkaHandler(KafkaProducerWrapper<String, String> kafkaProducerWrapper) {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Message message) throws Exception {
        ...
        if (header.getCode() == APP_INFO_REQ.value()) {
            ...
            send(ctx, message, SYSTEM_SETTING.getKafkaTopicApp(), MessageCode.APP_INFO_RESP);
        } else {
